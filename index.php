...
<div id="meat">
   ...
   <div id="content">
		<div id="promo" style="padding-left:15px; float: left;">
		  ...
		  <p> To sign up, go to profile, then follow the appropriate instructions. If you have already played the game, go all you need to do is take the <a href="/rules/quiz/rules_quiz.php">rules quiz</a>; this is simply to ensure that you have read the rules.  Once you have done this, come to the admin table in the Student Center (right across from the Chick-fil-a) to pick up your bandana.</p>
    </div>
